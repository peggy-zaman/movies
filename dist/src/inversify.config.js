...
const review_controller_1 = require("./src/controllers/review_controller");
const review_service_1 = require("./src/services/implementations/review_service");
exports.bindings = new inversify_1.AsyncContainerModule((bind) => __awaiter(this, void 0, void 0, function* () {
    ...
    bind(types_1.TYPES.Controller).to(review_controller_1.ReviewController).whenTargetNamed("ReviewController");
    bind(types_1.TYPES.ReviewService).to(review_service_1.ReviewService);
}));
